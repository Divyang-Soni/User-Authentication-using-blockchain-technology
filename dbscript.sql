...
CREATE TABLE IF NOT EXISTS user_profile(id serial PRIMARY KEY, user_id int NOT NULL, gender char(1), ethinicity int, country_of_residence int, country_of_citizenship int, address_line_1 VARCHAR(200), address_line_2 VARCHAR(50), city varchar(50), state varchar(50), country varchar(50), zip int, phone varchar(50), profile_photo VARCHAR(MAX), created_date date, created_by int, modified_date date, modified_by int, delete_flag int DEFAULT 0, deleted_by int);
